...
this problem. The connection-string parameter is supplied by the caller
of the .NET check (in the separate
[`execdb-drivers`](https://github.com/amisonnet8/execdb-drivers)
repository), not hardcoded in the check itself.
